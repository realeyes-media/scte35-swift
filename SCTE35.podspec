...
s.source_files  = "SCTE35-SwiftLibrary", "SCTE35-SwiftLibrary/HelperConverter/*.swift", "SCTE35-SwiftLibrary/**/*.{h,m,swift}", "SCTE35_SwiftLibraryTests/*.{swift}", "SharedResources/**/*.swift"
